...
def complete():
    ...
    name="aaa"
    text="bbb"
    db = firestore.Client.from_service_account_json('./project-tsubame-4501f3895aca.json')
...
#schedule.every().day.at("01:50").do(complete)
#schedule.every().day.at("10:00").do(complete)
schedule.every().day.at("09:10").do(complete)
schedule.every().day.at("12:10").do(complete)
schedule.every().day.at("18:10").do(complete)
