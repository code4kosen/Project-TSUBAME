...
This example dispatches to an API web under "/api", an admin web
under "/admin", and an web that serves frontend files for all other
requests::

    web = DispatcherMiddleware(serve_frontend, {
        '/api': api_app,
        '/admin': admin_app,
    })
